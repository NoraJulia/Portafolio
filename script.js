document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ...
    'proyecto-1-link': { es: 'Jugar en Itch.io', en: 'Play on Itch.io' },
    'proyecto-2-desc': { es: 'En este juego te embarcas a proteger el bosque mágico que está siendo atacado por criaturas de la oscuridad que desean apagar todo el brillo de este hermoso bosque.', en: 'In this game you embark on a quest to protect the magical forest being attacked by creatures of darkness who seek to extinguish all the light of this beautiful woodland.' },
    'proyecto-2-rol-1': { es: 'Programación del Juego', en: 'Game Programming' },
    'proyecto-2-rol-1-li-1': { es: 'Programé el boss final y su sistema de combate', en: 'Programmed the final boss and its combat system' },
    'proyecto-2-rol-1-li-2': { es: 'Participé en la mecánica de los enemigos y su programación', en: 'Worked on enemy mechanics and programming' },
    'proyecto-2-rol-1-li-3': { es: 'Programé el puzzle del juego', en: 'Programmed the game puzzle' },
    'proyecto-2-rol-2': { es: 'Diseño de nivel', en: 'Level Design' },
    'proyecto-2-rol-2-li-1': { es: 'Diseñé y agregué una parte del bosque mágico', en: 'Designed and built a section of the magical forest' },
    'proyecto-2-rol-2-li-2': { es: 'Diseñé el puzzle y lo implementé', en: 'Designed and implemented the puzzle' },
    'proyecto-2-rol-3': { es: 'Arte 3D', en: '3D Art' },
    'proyecto-2-rol-3-li-1': { es: 'Modelé las plataformas', en: 'Modeled the platforms' },
    'proyecto-2-rol-3-li-2': { es: 'Modelé las piedras de los puzzles', en: 'Modeled the puzzle stones' },
    'proyecto-2-rol-3-li-3': { es: 'Creé las partículas de los enemigos e implementé todo al motor', en: 'Created enemy particles and implemented everything in the engine' },
    ...
    'proyecto-3-desc': { es: 'En este juego lleno de color debes adentrarte junto a un compañero en un mundo de plataformas, donde la comunicación es clave para resolver puzzles y superar niveles con un giro que añade dificultad a cada desafío.', en: 'In this colorful game you venture alongside a partner into a platforming world, where communication is key to solving puzzles and clearing levels — with a twist that adds challenge at every turn.' },
    'proyecto-3-rol-1': { es: 'Arte 3D', en: '3D Art' },
    'proyecto-3-rol-1-li-1': { es: 'Creé assets y entornos tridimensionales para el juego', en: 'Created 3D assets and environments for the game' },
    'proyecto-3-rol-1-li-2': { es: 'Modelé y texturicé personajes y escenarios', en: 'Modeled and textured characters and scenarios' },
    'proyecto-3-rol-1-li-3': { es: 'Optimicé los modelos 3D para mejorar el rendimiento en el motor', en: 'Optimized 3D models for better engine performance' },
    ...
    'proyecto-3-link': { es: 'Jugar en Itch.io', en: 'Play on Itch.io' },
    'proyecto-4-desc': { es: 'En este juego eres un borrachito que estuvo bebiendo toda la noche y ahora debe encontrar el camino al trabajo. Debes estar atento, porque nada es lo que parece y podrías llegar al lugar equivocado.', en: 'In this game you are a little drunk who has been drinking all night and now must find the way to work. Stay alert, because nothing is as it seems and you might end up in the wrong place.' },
    'proyecto-4-rol-2': { es: 'Level Design', en: 'Level Design' },
    'proyecto-4-rol-2-li-1': { es: 'Diseñé escenarios urbanos con rutas engañosas y puntos de referencia cambiantes', en: 'Designed urban scenarios with deceptive routes and shifting landmarks' },
    'proyecto-4-rol-2-li-2': { es: 'Implementé puntos de control y elementos interactivos en el entorno', en: 'Implemented checkpoints and interactive elements in the environment' },
    'proyecto-4-rol-3': { es: '3D Art', en: '3D Art' },
    'proyecto-4-rol-3-li-1': { es: 'Modelé entornos urbanos y escenas para el juego', en: 'Modeled urban environments and scenes for the game' },
    'proyecto-4-rol-3-li-2': { es: 'Texturicé los assets y optimicé los modelos para el motor', en: 'Textured the assets and optimized models for the engine' },
    'proyecto-4-participacion': { es: 'Este proyecto fue creado para la Woman Game Jam. Participé en el modelado 3D de los entornos urbanos y en el diseño de nivel. Me centré en crear un entorno que hiciera perder al jugador pero que a la vez fuera llamativo. Trabajé estrechamente con el área de diseño 2D y animación 2D para poder llegar al producto final y al estilo que deseábamos.', en: 'This project was created for the Woman Game Jam. I participated in 3D modeling of urban environments and in level design. I focused on creating an environment that would disorient the player while still being visually striking. I worked closely with the 2D design and 2D animation team to achieve the final product and the style we wanted.' },
    'proyecto-4-link': { es: 'Jugar en Itch.io', en: 'Play on Itch.io' },
    'proyecto-0-name': { es: 'CLAWLLECTOR', en: 'CLAWLLECTOR' },
    'proyecto-0-desc': { es: 'Toma el control de esta flamante nave espacial y recoge la basura espacial que flota sobre nosotros. ¡Puede que incluso ganes algo de dinero por el camino! Pero recuerda: no toda la basura vale lo mismo; algunas piezas son más valiosas que otras. Con el dinero que ganes, podrás mejorar tu fiel nave hasta 5 niveles por categoría. Eso sí, recuerda aterrizar con cuidado, o podrías acabar explotando... ¡jajaja!', en: 'Take control of this brand-new spaceship and collect the space junk floating above us. You might even earn some money along the way! But remember: not all junk is worth the same; some pieces are more valuable than others. With the money you earn, you can upgrade your faithful ship up to 5 levels per category. Just remember to land carefully, or you might end up exploding... hahaha!' },
    'proyecto-0-link': { es: 'Jugar en Itch.io', en: 'Play on Itch.io' },
    'proyecto-0-rol-1': { es: 'Programación del juego', en: 'Game Programming' },
    'proyecto-0-rol-1-li-1': { es: 'Programé el controlador del cohete.', en: 'I programmed the rocket controller.' },
    'proyecto-0-rol-1-li-2': { es: 'Programé el funcionamiento de la garra.', en: 'I programmed the claw mechanics.' },
    'proyecto-0-rol-1-li-3': { es: 'Reuní todos los demás códigos y funciones para el producto final.', en: 'I gathered all the other code and functions for the final product.' },
    'proyecto-0-rol-2': { es: 'Diseño de videojuego', en: 'Game Design' },
    'proyecto-0-rol-2-li-1': { es: 'Ayudé a crear la idea del juego.', en: 'I helped create the game idea.' },
    'proyecto-0-rol-2-li-2': { es: 'Ayudé a diseñar los controles del cohete.', en: 'I helped design the rocket controls.' },
    'proyecto-0-rol-2-li-3': { es: 'Ayudé a crear la idea de la garra.', en: 'I helped create the idea for the claw.' },
    'proyecto-0-rol-2-li-4': { es: 'Ayudé a diseñar la idea de la tienda y la gasolinera.', en: 'I helped design the shop and the gas station.' },
    'proyecto-0-participacion': { es: 'Este fue el proyecto que presenté para la segunda Game Jam interna de Generation, creado en 48 horas junto a otros 3 compañeros. Mi participación en este proyecto se basó principalmente en programar las mecánicas del cohete, como el controlador, la garra y sus partículas. También ayudé a corregir errores y a guiar el proyecto para evitar problemas durante su creación. Otra parte importante fue reunir todo lo realizado por los demás compañeros en una sola escena y monitorear el repositorio del proyecto.', en: 'This was the project I presented for Generation\'s second internal Game Jam, created in 48 hours with 3 other teammates. My contribution focused mainly on programming the mechanics around the rocket, such as the controller, the claw and its particles. I also helped fix bugs and guide the project to avoid issues during its creation. Another important part was gathering everything made by my teammates into a single scene and monitoring the project\'s repository.' },
